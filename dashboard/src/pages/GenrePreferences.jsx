// Genre Preferences — reached at /settings/genres via the Settings hub
// (see pages/Settings.jsx). A full ranked list of every tiered genre,
// reorderable by drag or the up/down buttons (drag alone doesn't work on
// touch devices, so the buttons are the accessible/mobile-friendly path, not
// an afterthought).
//
